              ...
              <div className="col">
                <div className=" d-flex justify-content-around text-center flex-column">
                  ...
                  <div className="row" py-1>
                    ...
                    <div className="col-7">
                      <p className="fw-semibold">{book.bookName}</p>
                    </div>
                  </div>
                  <div className="row py-1">
                    <div className="col-5">
                    ...
                    <div className="col-7">
                      <p className="fw-semibold">{book.authorName}</p>
                    </div>
                  </div>
                  <div className="row py-1">
                    <div className="col-5">
                  ...
                  <div className="row py-1">
                    ...
                    <div className="col-7">
                      <p className="fw-semibold">{book.yearOfPublication}</p>
                    </div>
                  </div>
                  <div className="row py-1">
                    <div className="col-5">
                    ...
                    <div className="col-7">
                      <p className="fw-semibold">{book.numberOfPages}</p>
                    </div>
                  </div>
                  <div className="row py-1">
                    <div className="col-5">
                    ...
                    <div className="col-7">
                      <p className="fw-semibold">{book.discount}</p>
                    </div>
                  </div>
                  <div className="row py-1">
                    <div className="col-5">
                    ...
                    <div className="col-7">
                      <p className="fw-semibold">{book.condition}</p>
                    </div>
                  </div>
                  <div className="row py-1">
                    <div className="col-5">
                    ...
                    <div className="col-7">
                      <p className="fw-semibold">{book.description}</p>
                    </div>
                  </div>
                </div>
              </div>
